...
export default function SubmissionCard({ submission, onUpdate, onDelete, isSelected = false, onToggleSelect }: SubmissionCardProps) {
    ...
    <div className={`group relative p-5 rounded-xl border bg-[#1a2e23] transition-colors ${
      ...
      {onToggleSelect && (
        <button
          ...
          className={`absolute top-4 left-4 w-5 h-5 rounded border-2 flex items-center justify-center transition-all z-10 ${
            isSelected 
              ? "bg-violet-500 border-violet-500 text-white" 
              : "border-white/30 hover:border-violet-400 bg-transparent"
          }`}
