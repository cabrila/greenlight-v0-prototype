...
export default function HelpWizardModal({ onClose }: HelpWizardModalProps) {
  ...
  const steps = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900">Using Review Session for Presentations</h3>

          <div className="space-y-3">
            <h4 className="font-medium text-gray-800 flex items-center">
              <Play className="w-4 h-4 mr-2 text-emerald-500" />
              Opening Review Session
            </h4>
            <div className="pl-6 space-y-2">
              <p className="text-sm text-gray-600">
                1. Click <span className="font-medium text-emerald-600">Open Review Session</span> in the sidebar.
              </p>
              <p className="text-sm text-gray-600">
          ...
          <div className="space-y-3">
            ...
            <div className="pl-6 space-y-2">
              ...
              <p className="text-sm text-gray-600">3. Access actor details without leaving the Review Session.</p>
            </div>
          </div>

          <div className="bg-emerald-50 p-3 rounded-md border border-emerald-200">
            <p className="text-xs text-emerald-700">
              <strong>Pro Tip:</strong> The Review Session is ideal for director meetings and producer presentations. The clean
