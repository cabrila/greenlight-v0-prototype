...
export default function CastingForTVModal({ onClose }: CastingForTVModalProps) {
  ...
  const [activeView, setActiveView] = useState<"pipeline" | "grid" | "list" | "mix">("pipeline")
        ...
        {activeView === "mix" && (
          <div className="flex-1 flex items-center justify-center text-gray-400">
            <div className="text-center">
              ...
              <p className="text-lg font-medium">Cast Mix Matrix</p>
              <p className="text-sm">Visual grid for balancing your final cast</p>
