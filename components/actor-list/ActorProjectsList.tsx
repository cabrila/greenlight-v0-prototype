...
import { Plus, Users, Calendar, Pencil, Trash2, Database, ChevronRight } from "lucide-react"
...
export default function ActorProjectsList() {
  const { projects, selectProject, deleteProject, updateProject, setView, allActors } = useActorList()
  ...
  return (
    <div className="h-full overflow-y-auto p-6 md:p-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {/* All Actors - Special Permanent Card */}
        <button
          onClick={() => setView("all-actors")}
          className="group relative flex rounded-xl border-2 border-sky-500/30 bg-gradient-to-br from-sky-500/10 to-sky-600/5 hover:border-sky-500/50 hover:from-sky-500/15 hover:to-sky-600/10 transition-all overflow-hidden"
        >
          ...
          <div className="flex-1 flex flex-col justify-center p-5 text-left">
            {/* Label */}
